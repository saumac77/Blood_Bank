<%
	...
	cn.open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source =D:\WORKSPACE\pages\donor.mdb"
...
rs.update
cn.Execute("INSERT INTO donor VALUES('"&name&"','"&address&"','"&phone&"','"&gen&"','"&birth&"','"&A&"','"&ve&"')")
%>
<html>
<a href="http://localhost/WORKSPACE/pages/donor.html"> 
